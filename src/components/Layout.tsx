...
const navItems = [
  ...
  { to: '/daily-plan', label: '计划', icon: CalendarCheck2 },
...
function Brand() {
  return (
    <NavLink to="/photo-explain" className="brand">
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-card">
          ...
          <div>
            ...
            <small>{state.profile.grade}</small>
          </div>
        </div>
      ...
      <main className="main-area">
        <header className="mobile-topbar">
          <Brand />
          <div className="mobile-current">{current?.label || '学习'}</div>
        </header>
