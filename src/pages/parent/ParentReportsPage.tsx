...
export function ParentReportsPage() {
  ...
  return <div>
    ...
    <div className="parent-chart-grid parent-chart-grid--hero">
      <Card className="parent-report-trend"><SectionTitle title="近期小测趋势" description="完成小测后自动更新" /><div className="report-score"><strong>{dashboard.overview.latestQuizRate}%</strong><span>最近一次正确率</span></div><MiniLineChart values={dashboard.trend.length ? dashboard.trend : [0]} height={160} /></Card>
