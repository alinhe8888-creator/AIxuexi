...
export function ParentProgressPage() {
  ...
  return <div>
    ...
    <div className="parent-chart-grid parent-chart-grid--hero">
      <Card><SectionTitle title="学科能力雷达" description="综合掌握、正确率和复习稳定度" /><RadarChart items={radar.length >= 3 ? radar : [...radar, { label: '计划', value: dashboard.today.completionRate }, { label: '复习', value: Math.max(0, 100 - dashboard.overview.highRiskCount * 10) }].slice(0, 6)} /></Card>
